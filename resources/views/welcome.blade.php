    ...
    <body class="antialiased">
        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                {{--  --}}
                <div class="grid grid-cols-3" style="column-gap: 4rem;">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-1">
                                    <div class="p-6">
                                        <div class="flex items-center">
                                            <div class="text-lg leading-7 font-semibold">{{ $health['label'] }}</div>
                                        </div>

                                        <div>
                                            @if($health['status'] !== "OK")
                                                <div class="mt-8 font-semibold text-grey-600 dark:text-grey-400 text-sm" style="color: red;">
                                            @else
                                                <div class="mt-8 font-semibold text-grey-600 dark:text-grey-400 text-sm" style="color: green;">
                                            @endif
                                                {{ $health['status'] }}
                                            </div>
                                        </div>
